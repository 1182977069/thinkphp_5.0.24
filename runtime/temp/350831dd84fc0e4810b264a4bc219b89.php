<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\Users\li\Desktop\thinkphp_5.0.24\public/../application/admin\view\index\adminmenu.html";i:1563244468;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="layui-form" id="table-list">
						<table class="layui-table" lay-skin="line">
							...
							<tbody>
								...
								<tr id='node-4' class="child-node-1 parent collapsed" style="display: none;" parentid="1">
									...
									<td class="hidden-xs">Admin</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─前台菜单
										<a class="layui-btn layui-btn-mini layui-btn-normal showSubBtn" data-id='4'>+</a>
									</td>
								...
								<tr id='node-5' class="child-node-4 parent collapsed" style="display: none;" parentid="1">
