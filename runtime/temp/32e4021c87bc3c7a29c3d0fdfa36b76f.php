<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpstudy\WWW\thinkphp_5.0.24\public/../application/admin\view\index\index.html";i:1563931953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="<?php echo url('admin/index/adminmenu'); ?>" data-id='1' data-text="后台菜单"><span class="l-line"></span>后台菜单</a></dd>
				      <dd><a href="javascript:;" data-url="<?php echo url('admin/index/category'); ?>" data-id='2' data-text="前台分类"><span class="l-line"></span>前台分类</a></dd>
				    </dl>
				  </li>
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
						<li class="layui-nav-item">
							<a href="<?php echo url('index/index/index'); ?>">前台首页</a>
						</li>
